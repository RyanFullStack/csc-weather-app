  ...
  return (
    <div className={`nav-component ${theme}`}>
      ...
      <div className='nav-bottom-half'>
        <div>
          <NavLink exact to="/hangar" id="4" className={active === '4' && darkTheme === 'true' ? 'navbuttonactive' : active === '4' && darkTheme === 'false' ? 'navbuttonactivelight' : 'navbutton'} onClick={handleClick}>WEBCAMS</NavLink>
        </div>
        <div>
